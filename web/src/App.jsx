...
function AppLayout() {
  ...
  return (
    <div className="trio-shell flex flex-col md:flex-row h-screen overflow-hidden">
      {/* ── Top Navbar Mobile ────────────────────────── */}
      ...
      <main className="trio-main flex-1 flex flex-col h-full overflow-hidden relative pb-[68px] md:pb-0">
