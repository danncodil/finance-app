...
import { Mail, Lock, Eye, EyeOff, AlertTriangle, ArrowRight, Loader2 } from "lucide-react";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.status === 401) {
        ...
        setErrorMessage("Sua conta está desativada. Entre em contato com o suporte.");
      } else {
        setErrorMessage(err.message || "Não foi possível realizar o login. Tente novamente.");
      }
    } finally {
      setLoading(false);
    }
      ...
      <div className="w-full max-w-md animate-fade-in-up z-10">
        ...
        <div className="bg-slate-900/50 backdrop-blur-3xl rounded-3xl p-8 shadow-[0_8px_32px_rgba(0,0,0,0.5)] ring-1 ring-white/10">
          ...
          {errorMessage && (
            ...
            >
              ...
              <div className="text-xs font-medium leading-relaxed">
                <strong className="font-semibold block mb-0.5 text-rose-300">Atenção</strong>
                {errorMessage}
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    setErrorMessage("A recuperação de senha estará disponível em breve.");
                  }}
                  className="text-[11px] font-medium text-blue-400 hover:text-blue-300 transition-colors uppercase tracking-wider"
                >
                  Recuperar acesso
                </a>
              </div>
            ...
            {/* Botão de Submissão — Magnetic Blue */}
            <button
              id="btn-login-submit"
              type="submit"
              disabled={loading}
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-slate-900/50 text-slate-500 text-[11px] uppercase tracking-wider font-semibold">Ou continue com</span>
              </div>
            </div>
